        ...
        <div className={home.aboutpage}>
          <div className={home.aboutpagehero}>
            <div className={home.aboutmebav}>
              ...
              >
                <span className={`${home.line} ${menuOpen ? home.lineTop : ''}`}></span>
                <span className={`${home.line} ${menuOpen ? home.lineMiddle : ''}`}></span>
                <span className={`${home.line} ${menuOpen ? home.lineBottom : ''}`}></span>
              </button>
              <div className={`${home.navlink} ${menuOpen ? home.navlinkOpen : ''}`}>
